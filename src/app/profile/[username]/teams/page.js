    ...
    return (
        <div className="flex justify-center">
            <div className="w-full md:w-8/12">
                <h1 className="text-2xl ml-2 mb-4"><b>Your teams</b></h1>
                ...
                <Link href="/teams/" className="text-blue-700 hover:underline mx-4">Join more teams</Link>
            </div>
        </div>
    )
}
    ...
    return (
        <div key={`team-${index}`} className="flex justify-between py-4">
            <div className="flex items-center">
                <Link className="text-blue-700 hover:underline mx-4" href={`/teams/${team.id}`}>
                    {team.name}
                </Link>
