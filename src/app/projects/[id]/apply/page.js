		...
		<div className="flex justify-center">
			...
			<div className="w-full md:w-1/2 px-2">
				...
				>
						...
						project.coordinatorPositions.length > 0 && (
							<div>
								...
								<p className="mt-1 mb-4 text-sm text-gray-600">
									If you want to apply for more than one position, you will have
									to fill-out this application multiple times!
								</p>
							</div>
						)}
					...
					/>
					<p className="mt-1 mb-4 text-sm text-gray-600">
						Make sure to write at least 150 words, this is the most important
					...
					<div className="flex flex-row-reverse">
						<Button
							className="flex gap-1 justify-center w-full md:w-3/12"
							type="submit"
						>
							<CheckAllIcon />
							Apply
